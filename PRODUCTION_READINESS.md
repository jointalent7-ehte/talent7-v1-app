...
| --- | --- | --- | --- |
| Accounts | Connected | Supabase signup, confirmation, login, session restoration, logout, password change, reset email, and confirmation resend | Configure production SMTP and test confirmation/reset with two real inboxes |
...
| Analytics/monitoring | Not installed | Basic Vercel logs only | Add privacy-conscious error monitoring and product analytics |
