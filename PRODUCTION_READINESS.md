...
| Plans and support | Code complete, externally gated | One-time Supporter, Champion Supporter, and Founder Supporter purchases; web custom amount; server-verified permanent highest badge; payment history | Apply migration, configure Razorpay and Google Play, create Play products, connect webhooks/RTDN, and pass sandbox/Play-track tests before accepting money |
