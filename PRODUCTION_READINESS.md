...
| Listen | Connected | Supabase rooms, membership, reactions, song queue, owner archive/delete, and optional realtime refresh are available from the primary navigation | Retest public/private rooms, passcodes, reactions, queue links, archive, and deletion with two accounts |
...
| Supporter payments | Code complete, website provider pending | Three fixed supporter tiers plus custom ₹10–₹100,000 website support; server-verified permanent highest qualifying badge; payment history; three fixed Google Play products | Obtain written approval from a replacement website provider for the complete challenge/community model before integrating or accepting web money; finish Google Play setup separately |
