...
| Notifications | Connected | In-app notifications, private read state, and preference-controlled Firebase delivery cover invites, challenge updates, live rooms, voting, proof/results, and saved-room activity | Apply the notification and saved-room notification migrations, then test delivery on a connected Android phone |
...
6. `supabase/add-saved-room-notifications.sql`
